...
using Moq;
using SecFirstScratch.TagHelpers;
using System;
...
namespace SecFirstScratchTest.TagHelpers
{
    public class EmailTagHelperTests
    {
        ...
        {
            EmailTagHelper emailTagHelper = new EmailTagHelper() { Address = "kamil.kvasnicka@gmail.com", Content = "Email" }; ;
            ...
            Assert.Equal("mailto:kamil.kvasnicka@gmail.com", tagHelperOutput.Attributes[0].Value);
        }
    }
}
